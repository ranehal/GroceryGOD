...
- **Othoba Grocery Scoping & Othoba-Analytics Separation (2026-08-22, do not regress)**:
  - GroceryGOD strictly scrapes and aggregates **grocery-only categories** from Othoba (`https://othoba.com/daily-bazar`, `https://othoba.com/food-grocery`, `https://othoba.com/monthly-grocery-mega-discounts`, `https://othoba.com/bogo-grocery-month` and their subcategories).
