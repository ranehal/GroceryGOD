...
nb["cells"][0]["source"] = [
    ...
    "- **🔕 Clean Telegram Protocol (Strict Whitelist)**: Only two Telegram events are permitted: `📊 Aggregator Complete` (1-look table) and `✅ Kaggle Restart Triggered Successfully!`. Sub-repo summary is logged locally to `/tmp/p14_summary.log` only.\n",
